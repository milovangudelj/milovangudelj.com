...
const AnimatedBars = () => {
	...
	return (
		<div className="flex w-auto items-end overflow-hidden">
			<span
				id="bar1"
				className="bg-gray-300 dark:bg-gray-500 mr-[3px] h-2 w-1 opacity-75"
			/>
			<span
				id="bar2"
				className="bg-gray-300 dark:bg-gray-500 mr-[3px] h-1 w-1"
			/>
			<span
				id="bar3"
				className="bg-gray-300 dark:bg-gray-500 h-3 w-1 opacity-80"
			/>
		</div>
	);
};
	...
	return (
		<div className="mb-8 flex w-full flex-row-reverse items-center space-x-0 sm:flex-row sm:space-x-2">
			...
			<div className="inline-flex w-full max-w-full flex-col truncate sm:flex-row">
				{data?.songUrl ? (
					<a
						className="capsize text-gray-800 dark:text-gray-200 max-w-max  truncate font-medium"
						href={data.songUrl}
						target="_blank"
				...
				<span className="capsize text-gray-500 dark:text-gray-300 mx-2 hidden sm:block">
					{" – "}
				</span>
